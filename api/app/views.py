...
from .schemas import paramas_task_schema
...
def create_task():
    # Getting the object that client send.
    json = request.get_json(force=True)
    # Error si el obejto JSON no cumple las reglas
    error = paramas_task_schema.validate(json)
    if error:
        print(error)
